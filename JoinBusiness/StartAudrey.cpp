...
int main ()
{
  ...
  milli = 100000;
	...
	cout << "Join Harvis Received" << endl;
...
//ROUND 2
  ...
  */
  ...
  ifstream firstcsv;
	firstcsv.open("ForJoinStorm.csv");


  string decompResultBloom = resBloom2;

  ofstream participators;
	participators.open("ForJoinStormReduced.csv");
  ...
  firstcsv.close();
	firstcsv.open("ForJoinHarvis.csv");



  participators.close();
	participators.open("ForJoinHarvisReduced.csv");
