...
int main ()
{
  ...
  milli = 400000;
	...
	inputtemp.open("compressedbloomFinalMac.txt");
	inputhum.open("bitstringOUTMurphy.txt");
	...
	ofstream output;
	output.open("TESTUNCOMPRESSED.txt",ofstream::out);
	...
	ofstream outputcomp;
	outputcomp.open("TESTCOMPRESSED.txt",ofstream::out);
