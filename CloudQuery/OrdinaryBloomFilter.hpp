...
public:
     ...
     */
    explicit
    OrdinaryBloomFilter(uint8_t numHashes, double numBits)
    ...
    virtual void printFilter(){
      ...
      outputFile.open("bitstringprint.txt",std::ofstream::out);
    ...
    virtual void setFilter(){
      ...
      inputFile.open("bitstringread.txt",std::ifstream::in);
